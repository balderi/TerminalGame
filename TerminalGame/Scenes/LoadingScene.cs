...
namespace TerminalGame.Scenes
{
    class LoadingScene : IScene
    {
        ...
        public LoadingScene(Vector2 screenCenter)
        {
        ...
        {
            spriteBatch.DrawString(_largeFont, _loading, new Vector2((int)(_screenCenter.X - _loadCenter.X), (int)(_screenCenter.Y - _loadCenter.Y)), Color.LightGray);
