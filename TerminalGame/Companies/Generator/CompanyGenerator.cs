...
namespace TerminalGame.Companies.Generator
{
    ...
    {
        private static readonly string[] aName = new string[] { "Alpha", "Gamma", "Delta", "Epsilon", "Lambda", "Omicron", "Sigma", "Omega", "Holo", "Crypto", "Advanced", "Adaptive", "Air", "Aero", "Applied", "Auto", "Automated", "Automatic", "Bank", "Best", "Capital", "City", "Chem", "Com", "Commercial", "Compu", "Creative", "Cyber", "Dyn", "Dyna", "Dyno", "East", "Eastern", "Energy", "Elite", "Equity", "Excellent", "Excellency", "Express", "External", "Extreme", "Gen", "General", "Green", "Health", "Home", "Ini", "Initial", "International", "Key", "Max", "Mac", "Med", "Media", "Medical", "Micro", "National", "North", "Northern", "Office", "Omni", "Pharma", "Poly", "Quantum", "Regional", "Safe", "Sci", "SIM", "Simulated", "South", "Southern", "Super", "Synthetic", "Synth", "Virtual", "Void", "West", "Western" };
        private static readonly string[] bName = new string[] { " Associates", "help", "Help", " Help", " Automatics", " Computers", " Computer", " Computers", " Service", " Services", " Shipping", " Logistics", " Renovation", "Consult", " Consulting", " Construction", " Estates", " Power", " Electric", " Services", " Computer Services", " Technologies", " Tech", " Technology", " Energy", "field", "Field", "dyne", "Dyne", "tyne", "Tyne", " Energy", " Pharmaceuticals", " Pharma", "Pharm", " Financial", " Devices", " International", " Industial Technologies", "land", " Labs", "vox", "Vox", "tel", "Tel", "Nation", "net", "Net", " Group", " Products", "Zone", " Homes", "Sim", " Simulations", " Software", "Soft", "point", " Point", " Worldwide", "vision", "Vision", "Star", "ware", " Brands", "Air", " Air", " Airlines", " Airways", "Auto", " Auto", " Foods", " Healthcare" };
